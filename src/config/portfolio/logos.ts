...
export const logos: CompanyLogo[] = [
  { name: 'Honeycomb', src: '/company-logos/honeycomb.svg', href: 'https://www.honeycomb.io/', large: true },
  ...
  { name: 'Alinfo', src: '/company-logos/alinfo.png', href: 'https://alinfo.com.br/' }
];
