...
| `.github/workflows/ci.yml` | Build and Cloudflare Pages deploy |
...
CI runs on pushes and pull requests targeting `main`. It deploys to Cloudflare Pages (with preview environments for development branches). Production uses:
